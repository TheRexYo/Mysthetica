execute as @s at @s run effect give @e[distance=..2,tag=MagicMissile_Target] instant_damage 1 0 true
execute as @s at @s run tag @e[distance=..2,tag=MagicMissile_Target] add MagicMissile_Target_Remove
execute as @s at @s run execute as @e[distance=..2,tag=MagicMissile_Target] at @s run execute as @s at @s run schedule function arkane:libraries/magic/effects/magic_missile_target_remove 0.1s
